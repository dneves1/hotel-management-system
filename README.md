...
Sistema de gestão hoteleira em Python. Roda inteiramente no terminal e persiste os dados em arquivos `.txt`, sem depender de banco de dados externo.
...
Relatório técnico
O relatório técnico do projeto está disponível em RelatorioHotelManager.pdf
